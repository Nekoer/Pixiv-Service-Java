 ...
 */
@Api(value = "插画业务接口",tags = "处理插画相关操作")
@RestController
...
public class IllustController {
     ...
     */
    @ApiOperation(value = "查询插画详细数据",notes = "查询插画详细数据")
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(name = "reduction", value = "是否缓存", required = true, paramType = "query", dataType = "boolean"),
    })
    @RequestMapping(value = "detail", method = RequestMethod.GET, produces = MediaType.APPLICATION_JSON_VALUE)
    public Result detail(@RequestParam(value = "illustId") String illustId,@RequestHeader(value = "authorization",required = false) String authorization,@RequestParam(value = "reduction",required = false) boolean reduction) throws ExecutionException, InterruptedException {
        return illustService.detail(illustId,authorization,reduction);
    }

    @ApiOperation(value = "根据图片地址查看图片",notes = "根据图片地址查看图片")
    @ApiImplicitParams({
            @ApiImplicitParam(name = "url", value = "图片地址", required = true, paramType = "query", dataType = "string"),
            @ApiImplicitParam(name = "cache", value = "是否缓存", required = true, paramType = "query", dataType = "boolean"),
    })
    ...
    public String comments(@RequestParam(value = "illustId") String illustId,@RequestParam(value = "offset",required = false) Integer offset,@RequestParam(value = "include_total_comments",required = false) Boolean includeTotalComments){
        return illustService.comments(illustId,offset,includeTotalComments);
    }
     ...
     */
    @ApiOperation(value = "查看插画的排行榜",notes = "查看插画的排行榜")
    @ApiImplicitParams({
    ...
    @ApiOperation(value = "查看所有插画的数据",notes = "查看所有插画的数据")
